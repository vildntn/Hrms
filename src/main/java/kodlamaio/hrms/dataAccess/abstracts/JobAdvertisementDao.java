...
public interface JobAdvertisementDao extends JpaRepository<JobAdvertisement, Integer>{
	...
	"j.minSalary,j.maxSalary, j.openPosition,j.applicationDeadline, w.workType,jt.jobType, d.department,e.address)"
			+"From JobAdvertisement j Inner Join j.city c Inner Join j.employer e Inner Join j.workType w Inner Join j.jobType jt Inner Join j.department d "+
